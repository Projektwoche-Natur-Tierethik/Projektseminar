...
INSERT INTO "new_discussion" ("d_code", "d_id", "discussion_theme", "inclusion_problem_part_of", "norms_part_of", "step") SELECT "d_code", "d_id", "discussion_theme", "inclusion_problem_part_of", "norms_part_of", "step" FROM "discussion";
