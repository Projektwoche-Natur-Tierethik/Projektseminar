...
export const metadata = {
  title: "Feedback",
  description: "Feedback für Seminarleitung und Admins."
};
    ...
    <div className="container mx-auto space-y-8 pb-20 pt-12">
      <header className="space-y-2">
        ...
        <p className="text-muted">
          Direkte Rückmeldung an die Seminarleitung und Admins.
        </p>
      </header>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle>Rückmeldung an die Seminarleitung</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <Input placeholder="Name (optional)" />
            <Input placeholder="Email (optional)" type="email" />
            <Textarea rows={6} placeholder="Deine Rückmeldung..." />
            <Button>Rückmeldung senden (Mock)</Button>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
